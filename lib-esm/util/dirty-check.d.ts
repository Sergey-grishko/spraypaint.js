...
declare class DirtyChecker<T extends SpraypaintBase> {
    ...
    dirtyAttributes(): import("../model").ModelAttrChanges<import("./omit").Omit<T, "rollback" | "meta" | "reset" | "attributes" | "destroy" | "id" | "temp_id" | "stale" | "storeKey" | "onDeferredDestroy" | "onDeferredUpdate" | "afterSync" | "relationships" | "klass" | "isType" | "isPersisted" | "_onSyncRelationships" | "_onStoreChange" | "unlisten" | "listen" | "syncRelationships" | "isMarkedForDestruction" | "isMarkedForDisassociation" | "stored" | "typedAttributes" | "relationship" | "assignAttributes" | "setMeta" | "isMetaDirty" | "relationshipResourceIdentifiers" | "fromJsonapi" | "resourceIdentifier" | "errors" | "hasError" | "clearErrors" | "isDirty" | "changes" | "hasDirtyRelation" | "dup" | "save" | "resetRelationTracking" | "links" | "assignLinks">>;
